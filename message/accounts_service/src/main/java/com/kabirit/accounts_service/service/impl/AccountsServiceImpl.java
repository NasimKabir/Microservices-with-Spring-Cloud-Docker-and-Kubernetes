...
import com.kabirit.accounts_service.dto.AccountsMsgDto;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public Response createAccount(CustomerDto customerDto) {
        ...
        sendCommunications(accounts,savedCustomer);
    ...
    private void sendCommunications(Accounts accounts, Customer customer) {
        ...
        boolean result = streamBridge.send("sendCommunications-out-0", accountsMsgDto);
        log.info("Communication request sent successfully process : {}", result);
    }
